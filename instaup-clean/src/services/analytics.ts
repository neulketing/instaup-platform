...
class AnalyticsService {
  ...
  trackPurchase(orderId: string, amount: number, currency: string, items: any[]): void {
    this.track({
      name: 'purchase',
      properties: {
  ...
  trackServiceOrder(platform: string, service: string, quantity: number, price: number): void {
    this.track({
      name: 'service_order',
      properties: {
        platform,
