...
export default function AdminDashboard({ isOpen, onClose }: AdminDashboardProps) {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'orders' | 'users' | 'revenue' | 'analytics'>('overview')
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">실시간 비즈니스 분석 및 운영 현황</p>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6">
                      ...
                      <div className="mt-4 flex items-center">
                        ...
                        <span className="text-gray-500 text-sm ml-1">vs 어제</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-green-600">완료된 주문</p>
                      ...
                      <div className="mt-4 flex items-center">
                        ...
                        <span className="text-gray-500 text-sm ml-1">성공률</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-purple-600">활성 사용자</p>
                      ...
                      <div className="mt-4 flex items-center">
                        ...
                        <span className="text-gray-500 text-sm ml-1">신규 오늘</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-orange-600">진행 중 주문</p>
                      ...
                      <div className="mt-4 flex items-center">
                        ...
                        <span className="text-gray-500 text-sm ml-1">대기 중</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="bg-white rounded-lg border p-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">📱 플랫폼별 주문 분포</h3>
                      <div className="space-y-4">
                        {Object.entries(metrics.platforms).map(([platform, percentage]) => (
                    ...
                    <div className="bg-white rounded-lg border p-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">💳 결제 수단별 분포</h3>
                      <div className="space-y-4">
                        {Object.entries(metrics.payments).map(([method, percentage]) => (
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-lg border p-6">
                    ...
                    <div className="space-y-3">
                      {[
                        { time: '방금 전', event: '신규 주문', detail: 'Instagram 팔로워 1,000개 주문', type: 'order' },
                        { time: '2분 전', event: '결제 완료', detail: '카카오페이 50,000원 충전', type: 'payment' },
                        { time: '5분 전', event: '회원가입', detail: '신규 사용자 가입', type: 'user' },
                        { time: '8분 전', event: '주문 완료', detail: 'YouTube 구독자 500개 완료', type: 'complete' },
                        { time: '10분 전', event: '리필 요청', detail: 'Instagram 팔로워 리필 신청', type: 'refill' }
                      ].map((activity, index) => (
                  ...
                  <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-6 border">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">🤖 AI 인사이트 및 추천</h3>
                    <div className="space-y-4">
                      <div className="bg-white rounded-lg p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900">마케팅 최적화 제안</h4>
                      ...
                      <div className="bg-white rounded-lg p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900">수익 증대 기회</h4>
                            <p className="text-sm text-gray-600 mt-1">
                              YouTube 서비스 단가를 10% 인상하면 월 300만원 추가 수익이 예상됩니다.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900">주의 필요</h4>
                            <p className="text-sm text-gray-600 mt-1">
