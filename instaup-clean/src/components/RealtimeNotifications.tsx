...
import { supabaseService, useRealtimeNotifications, type NotificationData } from '../services/supabaseService'
...
const RealtimeNotifications = ({ userId, isVisible, onClose }: RealtimeNotificationsProps) => {
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="border-l-4 border-l-blue-500 bg-blue-50 p-3 rounded-r-lg">
                  <div className="flex items-start gap-3">
                    <span className="text-lg">📦</span>
                    <div className="flex-1">
                      <div className="font-medium text-gray-900">주문 진행 중</div>
                      <div className="text-sm text-gray-600 mt-1">
                ...
                <div className="border-l-4 border-l-purple-500 bg-purple-50 p-3 rounded-r-lg">
                  <div className="flex items-start gap-3">
                    <span className="text-lg">🎁</span>
                    <div className="flex-1">
                      <div className="font-medium text-gray-900">특별 할인 이벤트</div>
                      <div className="text-sm text-gray-600 mt-1">
...
// 알림 버튼 컴포넌트 (헤더에서 사용)
export const NotificationButton = ({ userId, onClick }: {
  userId: string | null
  onClick: () => void
}) => {
