...
export default function MobileBottomNav({ activeTab, onTabChange, isLoggedIn }: MobileBottomNavProps) {
  const tabs = [
    {
      id: 'home',
      label: '홈',
  ...
  const availableTabs = isLoggedIn ? tabs : tabs.filter(tab => ['home'].includes(tab.id))
