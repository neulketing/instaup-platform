          ...
          {isLoggedIn && userSession && (
            <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <div className="font-medium text-gray-900">{userSession.name}님</div>
            ...
            <div className="border-t pt-4 mt-4">
              {isLoggedIn ? (
                <div className="space-y-2">
                  ...
                  <button
                    onClick={() => handleMenuClick(() => onOrderHistoryClick?.())}
                    className="w-full text-left py-3 px-4 text-[#22426f] hover:bg-blue-50 rounded-lg font-medium transition-colors flex items-center gap-2"
                  >
                    📊 주문 내역
                  </button>
                  ...
                  <div className="border-t pt-2 mt-2">
                    <button
                      onClick={() => window.open('https://open.kakao.com/sns', '_blank')}
          ...
          <div className="mt-8 pt-4 border-t">
            <div className="text-center text-xs text-gray-500">
              <div className="mb-2">
                ...
                />
                <div className="font-medium">SNS샵 - 실제 한국인 SNS 마케팅</div>
              </div>
              <div className="space-y-1">
                <div>Version 2.1.0</div>
                <div>© 2024 SNS샵. All rights reserved.</div>
                <div>
                  <a href="/terms" className="hover:text-[#22426f]">이용약관</a>
                  {' · '}
                  <a href="/privacy" className="hover:text-[#22426f]">개인정보처리방침</a>
                </div>
              </div>
            </div>
          </div>
