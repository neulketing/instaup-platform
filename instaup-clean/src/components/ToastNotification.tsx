...
export default function ToastNotification({ messages, onRemove }: ToastNotificationProps) {
...
function ToastItem({ toast, onRemove, getToastIcon, getToastColors }: ToastItemProps) {
  ...
  return (
    ...
    >
      <div className={`p-4 rounded-lg border shadow-lg ${getToastColors(toast.type)} relative overflow-hidden`}>
        {/* 진행률 바 */}
