import { Platform, ServiceCategory, type ServiceItem, type PlatformInfo, type ServiceStats } from '../types/services'
...
export const servicesData: ServiceItem[] = [
  // 인스타그램 실제 한국인 팔로워 서비스 (SNS샵 완전 재현)
  {
    ...
    warningNote: '주문 전 공개 상태인지 확인해 주세요. 작업 진행 중 아이디 변경 및 비공개 전환 금지. 인스타 아이디를 변경하면 리필이 종료됩니다.'
  },
  {
    ...
    warningNote: '주문 전 공개 상태인지 확인해 주세요. 작업 진행 중 아이디 변경 및 비공개 전환 금지.'
  },
  {
  ...
  },
  {
    ...
    description: '저렴한 가격의 한국인 팔로워로 수치 증가에 특화된 서비스입니다.',
    price: 50,
    minOrder: 10,
    maxOrder: 30000,
    deliveryTime: '즉시 시작',
  ...
  },
  {
    ...
    description: '30일간 전문가가 계정을 최적화하여 관리해드리는 프리미엄 서비스입니다.',
    price: 150000,
    minOrder: 1,
    maxOrder: 3,
