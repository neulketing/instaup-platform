          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-blue-800">
                대부분의 궁금증은 아래 FAQ에서 해결할 수 있습니다.
                원하는 답변을 찾지 못하셨다면 고객센터로 문의해 주세요.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              ...
              <div className="text-sm text-gray-600 mb-2">24시간 실시간 상담</div>
            ...
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              ...
              <div className="text-sm text-gray-600 mb-2">support@instaup.kr</div>
              <button
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-600">
              평균 응답시간: <span className="font-medium text-blue-600">5분 이내</span> |
              고객 만족도: <span className="font-medium text-green-600">98.5%</span>
            </p>
          </div>
        </div>
      </div>
