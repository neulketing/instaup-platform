...
export default function AddFundsPage() {
  ...
  const [userSession, setUserSession] = useState(authManager.getCurrentSession())
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">잔액 충전을 하려면 로그인해주세요.</p>
          <button
            onClick={() => navigate('/')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">🎯 추천 충전 금액</h2>
                  ...
                  >
                    ...
                    {option.bonus > 0 && (
                      <div className="text-xs text-gray-500 mt-1">
                        실제: {(option.amount + option.bonus).toLocaleString()}원
                      </div>
                    )}
                  </button>
                ))}
          ...
          {/* 충전 내역 */}
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">📋 충전 내역</h2>

            {loading ? (
              <div className="text-center py-8">
                <div className="inline-block animate-spin rounded-full h-6 w-6 border-b-2 border-[#22426f]"></div>
                <p className="mt-2 text-sm text-gray-600">충전 내역을 불러오고 있습니다...</p>
              </div>
            ) : rechargeHistory.length === 0 ? (
              <div className="text-center py-8">
                <div className="text-gray-500 mb-2">💳 충전 내역이 없습니다</div>
                  ...
                  <div key={history.id} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-600">{history.method}</span>
                      </div>
                    ...
                    <div className="text-xs text-gray-500">
                      신청: {new Date(history.createdAt).toLocaleDateString('ko-KR', {
                        year: 'numeric',
                        month: 'short',
                        day: 'numeric',
                        hour: '2-digit',
                      ...
                      {history.paidAt && (
                        <>
                          <br />
                          완료: {new Date(history.paidAt).toLocaleDateString('ko-KR', {
                            year: 'numeric',
                            month: 'short',
                            day: 'numeric',
                            hour: '2-digit',
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              ...
              <div className="font-medium text-gray-900 mb-1">카카오톡 상담</div>
            ...
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              <div className="text-2xl mb-2">🕐</div>
              <div className="font-medium text-gray-900 mb-1">평균 응답시간</div>
