...
export default function GuidePage() {
  ...
  const guideSections: GuideSection[] = [
    ...
    },
    {
      ...
      icon: '📸',
      description: 'Instagram 좋아요, 팔로워, 조회수 서비스 이용 방법을 설명합니다.',
      steps: [
        {
          title: '1. 계정 공개 설정',
          content: '• Instagram 앱에서 프로필 > 설정 이동\n• "개인정보 보호" > "비공개 계정" 끄기\n• 계정이 공개 상태인지 확인\n• 게시물도 공개 설정 확인',
    ...
    },
    {
      ...
      icon: '📺',
      description: 'YouTube 조회수, 구독자, 좋아요 서비스 이용 방법을 안내합니다.',
      steps: [
        {
          title: '1. 동영상 공개 설정',
          content: '• YouTube Studio 접속\n• 콘텐츠 > 동영상 선택\n• 공개 상태 "공개"로 설정\n• 연령 제한 없음으로 설정\n• 변경사항 저장',
          tip: '비공개나 한정공개 동영상에는 서비스 제공이 불가능합니다.'
        },
        {
          title: '2. 동영상 URL 복사하기',
          content: '• 대상 동영상 페이지 이동\n• 주소창에서 URL 복사\n• 또는 "공유" 버튼 > "복사" 클릭\n• 짧은 URL(youtu.be)도 가능',
        ...
        {
          title: '4. 구독자 늘리기',
          content: '• 채널 URL 준비 (youtube.com/channel/...)\n• 현재 구독자 수 확인\n• 적정 수량 선택\n• 고품질 구독자 제공\n• 30일 리필 보장',
    ...
    },
    {
      ...
      steps: [
        {
          title: '1. 적정 수량 선택하기',
          content: '• 기존 팔로워/좋아요 수의 2-5배 이내 권장\n• 한 번에 너무 많은 수량 주문 금지\n• 계정 규모에 맞는 자연스러운 증가\n• 의심스러운 급증 피하기',
          tip: '자연스러운 성장이 가장 안전합니다!'
        },
        {
          title: '2. 주문 간격 조절하기',
          content: '• 연속 주문 시 최소 24시간 간격 유지\n• 다양한 게시물에 분산 주문\n• 한 게시물에 반복 주문 자제\n• 계정별 월 한도 확인',
          tip: '꾸준한 활동과 함께 서비스를 이용하세요.'
        },
        {
          title: '3. 계정 관리하기',
          content: '• 정기적인 게시물 업로드\n• 팔로워와의 소통 유지\n• 프로필 정보 완성하기\n• 해시태그 적절히 활용\n• 커뮤니티 가이드라인 준수',
          tip: '활발한 계정 활동이 효과를 극대화합니다.'
        },
        {
          title: '4. 문제 발생 시 대응',
          content: '• 즉시 서비스 중단 요청\n• 고객센터에 상황 신고\n• 계정 상태 모니터링\n• 플랫폼 정책 변경 확인\n• 필요시 백업 계정 준비',
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-700">
                처음 이용하시는 분부터 고급 사용자까지, 모든 기능을 안전하고 효과적으로 이용하는 방법을 단계별로 안내합니다.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-8">
                ...
                <div className="mb-8">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm text-gray-500">{currentSection.steps.length}단계</span>
                  </div>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-sm p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              가이드를 따라했는데도 문제가 해결되지 않는다면 언제든지 문의해 주세요.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <button
                onClick={() => window.location.href = 'mailto:support@instaup.kr'}
